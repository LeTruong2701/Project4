...
#users_name { background-position: 10px 10px !important }
...
<div class="container">
	<section id="content">
		<form action="">
			<h1>ADMIN LTSHOP</h1>
			<div>
				<input type="text" placeholder="Nhập tài khoản" name="users_name" required="" id="users_name" />
			</div>
			<div>
				<input type="password" placeholder="Nhập mật khẩu" name="password" required="" id="password" />
			</div>
			<div>
				<input type="submit" ng-click="Login()" value="Đăng nhập" />
